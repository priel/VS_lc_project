...
#define INIT_SPACING_STD 0.0001 ///the standart deviation of the inital location of the location
#define INIT_SPIN_STD 1.0 ///the standart deviation of the inital location of the spin
//can't be zero!

#define TEMPERATURE_RANGE {3.0, 2.8, 2.5, 2.0, 1.75, 1.5, 1.25, 1.0, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0.05, 0.01, 0.001}  ///temperature range of the monte carlo

#define NUMBER_OF_STEPS 50000 ///number of steps in each temperature

#define STD_LOCATION 0.00000001 ///the standart deviation of the location in the monte carlo
#define STD_SPIN 0.001 ///the standart deviation of the orientation in the monte carlo
//can't be zero!

//L > D
#define D_0 1.0 /// the small size of the liquid crystal molecule.
#define L_0 2.0 /// the long size of the liquid crystal molecule
